...
for idx, file in tqdm(enumerate(glob.glob('train\*.png')[:23])):
    ...
    img.crop((0, 0, 512,512)).save(f'./trainData/Images/{idx}.png')
    img.crop((512, 0, 1024, 512)).save(f'./trainData/Sketches/{idx}.png')
...
for idx, file in tqdm(enumerate(glob.glob('val\*.png')[:23])):
    ...
    img.crop((0, 0, 512,512)).save(f'./valData/Images/{idx}.png')
    img.crop((512, 0, 1024, 512)).save(f'./valData/Sketches/{idx}.png')
